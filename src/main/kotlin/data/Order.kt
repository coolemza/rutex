...
data class Order(var id: Long, var summarize_id: Long, var stockOrderId: String, val type: String,
                 ...
                 var feeVal: BigDecimal, val stock: String, var status: OrderStatus, var  attempt: Int = 0, val botId: Int = 0) {
    ...
    constructor(stock: String, type: String, pair: String, rate: BigDecimal, amount: BigDecimal) : this(Math.abs(UUID.randomUUID().hashCode()).toLong(),
            0L, "0", type, pair, rate, amount, amount, amount, amount, BigDecimal.ZERO, BigDecimal.ZERO, stock, OrderStatus.ACTIVE)
