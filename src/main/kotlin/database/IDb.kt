...
data class StockInfo(val id: Int, val ratio: BigDecimal, val historyId: Long)
...
interface IDb {
    ...
    fun getKeys(name: String, keyName: String): List<StockKey>
    fun getStockPairs(name: String): Map<String, PairInfo>
    fun getStockCurrencies(name: String): Map<String, StockCurrencyInfo>
    fun getCrossLimits(stock: String, runningStocks: Set<String>, less: Boolean = false): CrossBalance
    ...
    fun saveHistoryId(id: Long, stockName: String)
    ...
    fun getTestWallet(stock: String): MutableMap<String, BigDecimal>
